...
def main():
    ...
    parser.add_argument('-r', '--redd', nargs='+', type=int, help='Enables conversion for REDD dataset. Needs to specify buildings.')
    ...
    if args['redd']:
        ...
        ReddConverter(dir_path=path.realpath(path.join(getcwd(), path.dirname(__file__)))[:-4]).convert_df(args['redd'])
